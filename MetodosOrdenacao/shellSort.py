    ...
    def shellSort(self, Lista):
        ...
        while intervalo > 0:
            for i in range(intervalo, n):  # pega o intervalo e verifica até o tamanho da tabela
                ...
                while indexAux >= intervalo:
                    contComparacoes += 1  # Incrementa a contagem de comparações aqui
                    if Lista[indexAux - intervalo] > valorAtual:  # verifica se os valores de determinado setor são menores que sua outra versão
                        ...
                        contTrocas += 1  # Incrementa a contagem de trocas
                    else:
                        break
